...
class TapperCanningLineOne extends Component
{
    use WithPagination;
    ...
    public function exportData()
    {
        ...
        return Excel::download(new PalletRegistrationExport($this->startDate, $this->endDate, 'Tapper beer', 'Canning line 1'), 'Canningline1.xlsx');
//        return Excel::download(new PalletRegistrationExport($this->startDate, $this->endDate), 'filtered_data.xlsx');
    ...
    public function getPalletsQuery()
    {
        ...
        $query = PalletRegister::query()->where('product_type','Tapper beer')->where('production_line', 'Canning line 1' );
