        ...
        <div class="w-full px-6 mx-auto mt-6 ">
            ...
            <div class="relative overflow-hidden bg-white shadow-md sm:rounded-lg dark:bg-gray-800">
                <div class="flex items-center justify-between p-4 d">
                    <x-theme.button wire:navigate :href="route('create.customer')"
                                    :active="request()->routeIs('create.customer')">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        @foreach ($customers as $user)
                            <tr wire:key="{{ $user->id }}" class="border-b">
                                ...
                                <a wire:navigate href="{{ route('edit.customer', $user->id) }}" title="Edit Student">
