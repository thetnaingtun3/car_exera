                                        ...
                                        @if ($car_id === 'other')
                                            ...
                                            <div class="w-full py-2">
                                                <x-form.input wire:model.live="other_truck_licence_plate" type="text"
                                                    label="Truck Number" oninput="formatLicencePlate(this)"
                                                    placeholder="XX-YYYY" />


                                                @error('other_truck_licence_plate')
                                        ...
                                        <div class="w-full mt-4 bg-gray-300  rounded-md">
                                            @foreach ($products as $index => $product)
                                                <div class="flex items-center px-4 py-3 border-b bg-gray-300">
                                                    <!-- Product name -->
                                                    <p class="flex-1 text-sm font-medium">{{ $product['product'] }}
                                                    </p>
